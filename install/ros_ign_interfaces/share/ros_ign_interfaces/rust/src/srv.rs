...
pub struct ControlWorld_Request {
    ...
    pub world_control: ros_gz_interfaces::msg::WorldControl,
...
impl rosidl_runtime_rs::Message for ControlWorld_Request {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        world_control: ros_gz_interfaces::msg::WorldControl::into_rmw_message(std::borrow::Cow::Owned(msg.world_control)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        world_control: ros_gz_interfaces::msg::WorldControl::into_rmw_message(std::borrow::Cow::Borrowed(&msg.world_control)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      world_control: ros_gz_interfaces::msg::WorldControl::from_rmw_message(msg.world_control),
    }
  }
}
...
pub struct DeleteEntity_Request {
    ...
    pub entity: ros_gz_interfaces::msg::Entity,
...
impl rosidl_runtime_rs::Message for DeleteEntity_Request {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        entity: ros_gz_interfaces::msg::Entity::into_rmw_message(std::borrow::Cow::Owned(msg.entity)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        entity: ros_gz_interfaces::msg::Entity::into_rmw_message(std::borrow::Cow::Borrowed(&msg.entity)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      entity: ros_gz_interfaces::msg::Entity::from_rmw_message(msg.entity),
    }
  }
}
...
pub struct SpawnEntity_Request {
    ...
    pub entity_factory: ros_gz_interfaces::msg::EntityFactory,
...
impl rosidl_runtime_rs::Message for SpawnEntity_Request {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        entity_factory: ros_gz_interfaces::msg::EntityFactory::into_rmw_message(std::borrow::Cow::Owned(msg.entity_factory)).into_owned(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        entity_factory: ros_gz_interfaces::msg::EntityFactory::into_rmw_message(std::borrow::Cow::Borrowed(&msg.entity_factory)).into_owned(),
      })
    }
  }
  ...
  fn from_rmw_message(msg: Self::RmwMsg) -> Self {
    Self {
      entity_factory: ros_gz_interfaces::msg::EntityFactory::from_rmw_message(msg.entity_factory),
    }
  }
}
