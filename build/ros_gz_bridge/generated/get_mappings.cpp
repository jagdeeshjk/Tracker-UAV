...
get_gz_to_ros_mapping(const std::string & gz_type_name, std::string & ros_type_name)
{
  ...
  if (gz_type_name == "gz.msgs.EntityFactory" || gz_type_name == "ignition.msgs.EntityFactory")
  {
    ros_type_name = "ros_gz_interfaces/msg/EntityFactory";
    return true;
  }
...
get_ros_to_gz_mapping(const std::string & ros_type_name, std::string & gz_type_name)
{
  ...
  if (ros_type_name == "ros_gz_interfaces/msg/EntityFactory")
  {
  ...
  if (ros_type_name == "sensor_msgs/msg/Range")
  {
    gz_type_name = "gz.msgs.LaserScan";
    return true;
  }
...
get_all_message_mappings_ros_to_gz()
{
  static std::multimap<std::string, std::string> mappings = {
    ...
    {
      "ros_gz_interfaces/msg/EntityFactory",  // ROS 2
      "gz.msgs.EntityFactory", // Gazebo
    },
    {
      "ros_gz_interfaces/msg/EntityFactory",  // ROS 2
      "ignition.msgs.EntityFactory", // Gazebo
    },
    {
