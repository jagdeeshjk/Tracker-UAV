  ...
  const std::string & gz_type_name)
{
  ...
  if ((ros_type_name == "ros_gz_interfaces/msg/EntityFactory" || ros_type_name.empty()) &&
      (gz_type_name == "gz.msgs.EntityFactory" || gz_type_name == "ignition.msgs.EntityFactory"))
  {
    return std::make_shared<
      Factory<
      ...
      >
    >("ros_gz_interfaces/msg/EntityFactory", "gz.msgs.EntityFactory");
  }
