...
int main(int /*argc*/, char **/*argv*/)
{
  ...
  auto entityfactory_entityfactory_pub =
    node.Advertise<gz::msgs::EntityFactory>("entityfactory_entityfactory");
  gz::msgs::EntityFactory entityfactory_entityfactory_msg;
  ...
  auto laserscan_range_pub =
    node.Advertise<gz::msgs::LaserScan>("laserscan_range");
  gz::msgs::LaserScan laserscan_range_msg;
