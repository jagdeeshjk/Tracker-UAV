...
int main(int argc, char ** argv)
{
  ...
  auto entityfactory_entityfactory_pub =
    node->create_publisher<ros_gz_interfaces::msg::EntityFactory>("entityfactory_entityfactory", 1);
  ros_gz_interfaces::msg::EntityFactory entityfactory_entityfactory_msg;
  ros_gz_bridge::testing::createTestMsg(entityfactory_entityfactory_msg);
  ...
  auto laserscan_range_pub =
    node->create_publisher<sensor_msgs::msg::Range>("laserscan_range", 1);
  sensor_msgs::msg::Range laserscan_range_msg;
  ros_gz_bridge::testing::createTestMsg(laserscan_range_msg);
  ...
  while (rclcpp::ok()) {
    ...
    entityfactory_entityfactory_pub->publish(entityfactory_entityfactory_msg);
    ...
    laserscan_range_pub->publish(laserscan_range_msg);
